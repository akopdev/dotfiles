# System
alias c="clear"
alias ls="eza --group-directories-first --icons --all --no-quotes"
alias l="eza --group-directories-first --icons --oneline --all --no-quotes"
alias ll="eza --group-directories-first --icons --long --all --git --no-quotes"
alias lt="eza --group-directories-first --icons --tree --all --level=3 --no-quotes --ignore-glob '.git|node_modules|.pytest_cache|__pycache__'"
alias f="find-text"
alias ff="find-file"
case "$(uname)" in
